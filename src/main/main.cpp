...
int main() {
  ...
  // Plugin renders its own tab content (toolbar/body model).
  tabs.render_tab_content("tab-firefox.gecko#2");
  tabs.render_tab_content("tab-chromium.cef#1");

  // Simulate address bar in Gecko tab.
  tabs.on_address_submitted("tab-firefox.gecko#2", "https://www.mozilla.org");
